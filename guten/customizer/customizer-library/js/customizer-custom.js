...
( function( $ ) {
    ...
    $( document ).ready( function () {
        ...
        guten_search_check();
        $( '#customize-control-guten-header-search input[type=checkbox]' ).on( 'change', function() {
            guten_search_check();
        });
        function guten_search_check() {
            if ( $( '#customize-control-guten-header-search input[type=checkbox]' ).is( ':checked' ) ) {
                $( '#sub-accordion-section-guten-site-layout-section-header #customize-control-guten-header-search-txt' ).hide();
            } else {
                $( '#sub-accordion-section-guten-site-layout-section-header #customize-control-guten-header-search-txt' ).show();
            }
        }
