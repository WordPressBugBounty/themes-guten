...
function customizer_library_guten_options() {
    ...
    $options['guten-help-note-site-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'help',
        'description' => __( '<span><b>Guten Premium Features:</b><br />- Pro offers a new Website Loader<br/>- Guten Pro also comes with Page Layouts to import<br />- Add a Back To Top button<br />- Premium offers extra built in SEO settings</span>', 'guten' )
    );
    ...
    $options['guten-header-search-txt'] = array(
        'id' => 'guten-header-search-txt',
        'label'   => __( 'Search Placeholder Text', 'guten' ),
        'section' => $section,
        'type'    => 'text',
        'default' => __( 'Search & hit enter...', 'guten' )
    );
    ...
    $options['guten-help-note-blog-list'] = array(
        ...
        'section' => $section,
        'type'    => 'help',
        'description' => __( '<span><b>Guten Premium Features:</b><br />- AJAX Load More Blog Posts button<br />- AJAX Infinity Scroll - Load as user scrolls<br />- Change Blog Next/Prev to Numeric Pagination<br />- Display Full Post or Customized Summary of post<br />- Remove Post Date and/or author<br />- Remove Post Categories and/or tags<br />- Blocks Layout: Remove Post content/summary</span>', 'guten' )
    );
    ...
    $options['guten-single-remove-pagination'] = array(
        'id' => 'guten-single-remove-pagination',
        'label'   => __( 'Remove Post Pagination', 'guten' ),
        'section' => $section,
        'type'    => 'checkbox',
        'default' => 0,
    );
    $options['guten-help-note-blog-single'] = array(
        ...
        'section' => $section,
        'type'    => 'help',
        'description' => __( '<span><b>Guten Premium Features:</b><br />- Remove OR Change pagination to Side Arrows<br />- Remove Side Aligned Social links on Post<br />- Move Comments Form above/below comments</span>', 'guten' )
    );
    ...
    $options['guten-help-note-footer'] = array(
        ...
        'section' => $section,
        'type'    => 'help',
        'description' => __( '<span><b>Guten Premium Features:</b><br />- Remove/Edit Site Attribution copyright text<br />- Add SiteBy link to footer for link backs<br />- Remove the Footer Bottom Bar</span>', 'guten' )
    );
    ...
    $options['guten-nav-font-size'] = array(
        'id' => 'guten-nav-font-size',
        'label'   => __( 'Navigation Font Size', 'guten' ),
        'section' => $section,
        'type'    => 'range',
        'input_attrs' => array(
            'min'   => 0.7,
    ...
    $options['guten-social-tiktok'] = array(
        'id' => 'guten-social-tiktok',
        'label'   => __( 'TikTok', 'guten' ),
        'section' => $section,
        'type'    => 'text',
    );
    ...
    // $section = 'guten-plugin-support-section';

    // $sections[] = array(
    //     'id' => $section,
    //     'title' => __( 'Plugin Support', 'guten' ),
    //     'priority' => '120',
    //     'description' => __( 'Guten adds/removes custom styling to support external plugins', 'guten' )
    // );
    
    // $options['guten-plugin-buddypress'] = array(
    //     'id' => 'guten-plugin-buddypress',
    //     'label'   => __( 'BuddyPress', 'guten' ),
    //     'section' => $section,
    //     'type'    => 'checkbox',
    //     'default' => 0,
    // );
