	...
	<div class="site-footer-icons">
        <div class="site-container">
            ...
            <?php if ( !get_theme_mod( 'guten-footer-remove-social', customizer_library_get_default( 'guten-footer-remove-social' ) ) ) : ?>
				...
				if( get_theme_mod( 'guten-social-tiktok' ) ) :
				    echo '<a href="' . esc_url( get_theme_mod( 'guten-social-tiktok' ) ) . '" target="_blank" title="' . esc_attr__( 'Follow Us on TikTok', 'guten' ) . '" class="footer-social-icon footer-social-tiktok"><i class="fab fa-tiktok"></i></a>';
				endif;
