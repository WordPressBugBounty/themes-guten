...
<?php if ( !get_theme_mod( 'guten-header-remove-topbar', customizer_library_get_default( 'guten-header-remove-topbar' ) ) ) : ?>
	<div class="site-top-bar guten-header-five <?php echo ( get_theme_mod( 'guten-header-topbar-switch', customizer_library_get_default( 'guten-header-topbar-switch' ) ) ) ? sanitize_html_class( 'site-top-bar-switch' ) : ''; ?>">
	...
	<div class="site-container">
		...
		<div class="site-branding <?php echo ( get_theme_mod( 'guten-title-tagline-position', customizer_library_get_default( 'guten-title-tagline-position' ) ) ) ? sanitize_html_class( 'site-branding-float-all' ) : ''; ?> <?php echo ( has_custom_logo() ) ? sanitize_html_class( 'site-branding-logo' ) : sanitize_html_class( 'site-branding-nologo' ); ?>">
			...
			<?php if ( has_custom_logo() ) : ?>
				<?php the_custom_logo(); ?>
				<div class="site-branding-block <?php echo ( get_theme_mod( 'guten-title-tagline-position' ) ) ? sanitize_html_class( 'site-branding-float' ) : ''; ?>">
		...
		<div class="site-header-top <?php echo ( get_theme_mod( 'guten-social-color-header', customizer_library_get_default( 'guten-social-color-header' ) ) ) ? sanitize_html_class( 'social-icons-color' ) : ''; ?>">
