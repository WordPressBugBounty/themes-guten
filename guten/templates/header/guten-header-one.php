...
<?php if ( !get_theme_mod( 'guten-header-remove-topbar', customizer_library_get_default( 'guten-header-remove-topbar' ) ) ) : ?>
	<div class="site-top-bar guten-header-one <?php echo ( get_theme_mod( 'guten-header-topbar-switch', customizer_library_get_default( 'guten-header-topbar-switch' ) ) ) ? sanitize_html_class( 'site-top-bar-switch' ) : ''; ?> <?php echo ( get_theme_mod( 'guten-header-switch', customizer_library_get_default( 'guten-header-switch' ) ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?>">
...
<header id="masthead" class="site-header guten-header-one <?php echo ( get_theme_mod( 'guten-header-switch' ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?>" role="banner">
	...
	<?php if ( !get_theme_mod( 'guten-header-remove-main-nav', customizer_library_get_default( 'guten-header-remove-main-nav' ) ) ) : ?>
		<div class="site-header-top">
			...
			<div class="site-container">
				...
				<div class="site-header-top-right <?php echo ( get_theme_mod( 'guten-social-color-header', customizer_library_get_default( 'guten-social-color-header' ) ) ) ? sanitize_html_class( 'social-icons-color' ) : ''; ?>">
