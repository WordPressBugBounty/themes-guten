...
<?php if ( !get_theme_mod( 'guten-header-remove-topbar', customizer_library_get_default( 'guten-header-remove-topbar' ) ) ) : ?>
	<div class="site-top-bar guten-header-default <?php echo ( get_theme_mod( 'guten-header-topbar-switch', customizer_library_get_default( 'guten-header-topbar-switch' ) ) ) ? sanitize_html_class( 'site-top-bar-switch' ) : ''; ?>">
		...
		<div class="site-container">
			...
			<div class="site-top-bar-right <?php echo ( get_theme_mod( 'guten-social-color-header', customizer_library_get_default( 'guten-social-color-header' ) ) ) ? sanitize_html_class( 'social-icons-color' ) : ''; ?>">
...
<?php if ( is_front_page() ) : ?>
	...
	<?php if ( 'guten-no-slider' == get_theme_mod( 'guten-slider-type', customizer_library_get_default( 'guten-slider-type' ) ) ) : ?>
		<header id="masthead" class="site-header guten-header-default site-header-nobanner <?php echo ( get_theme_mod( 'guten-header-switch', customizer_library_get_default( 'guten-header-switch' ) ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?>" role="banner">
	<?php elseif ( 'guten-shortcode-slider' == get_theme_mod( 'guten-slider-type', customizer_library_get_default( 'guten-slider-type' ) ) ) : ?>
		<header id="masthead" class="site-header guten-header-default <?php echo ( get_theme_mod( 'guten-header-switch', customizer_library_get_default( 'guten-header-switch' ) ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?> <?php echo ( get_theme_mod( 'guten-slider-shortcode' ) ) ? '' : sanitize_html_class( 'site-header-nobanner' ); ?>" role="banner">
	<?php elseif ( 'guten-home-featured-image' == get_theme_mod( 'guten-slider-type', customizer_library_get_default( 'guten-slider-type' ) ) ) : ?>
		<header id="masthead" class="site-header guten-header-default <?php echo ( get_theme_mod( 'guten-header-switch', customizer_library_get_default( 'guten-header-switch' ) ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?> <?php echo ( has_post_thumbnail() ) ? '' : sanitize_html_class( 'site-header-nobanner' ); ?>" role="banner">
	<?php else : ?>
		<header id="masthead" class="site-header guten-header-default  <?php echo ( get_theme_mod( 'guten-header-switch', customizer_library_get_default( 'guten-header-switch' ) ) ) ? sanitize_html_class( 'site-header-switch' ) : ''; ?>" role="banner">
	<?php endif; ?>
