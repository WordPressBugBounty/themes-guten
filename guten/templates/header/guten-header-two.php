...
<?php if ( !get_theme_mod( 'guten-header-remove-topbar', customizer_library_get_default( 'guten-header-remove-topbar' ) ) ) : ?>
	<div class="site-top-bar guten-header-two <?php echo ( get_theme_mod( 'guten-header-topbar-switch', customizer_library_get_default( 'guten-header-topbar-switch' ) ) ) ? sanitize_html_class( 'site-top-bar-switch' ) : ''; ?>">
...
<header id="masthead" class="site-header guten-header-two <?php echo ( is_front_page() && get_theme_mod( 'guten-header-remove-slider-space', customizer_library_get_default( 'guten-header-remove-slider-space' ) ) ) ? sanitize_html_class( 'site-header-nospace' ) : ''; ?> <?php echo ( get_theme_mod( 'guten-header-remove-main-nav', customizer_library_get_default( 'guten-header-remove-main-nav' ) ) ) ? sanitize_html_class( 'site-no-nav' ) : ''; ?>" role="banner">
