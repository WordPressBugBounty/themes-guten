...
if( get_theme_mod( 'guten-social-tiktok' ) ) :
    echo '<a href="' . esc_url( get_theme_mod( 'guten-social-tiktok' ) ) . '" target="_blank" title="' . esc_attr__( 'Follow Us on TikTok', 'guten' ) . '" class="social-icon social-tiktok"><i class="fab fa-tiktok"></i></a>';
endif;
